...
export class UsersService {
  ...
  /**
   * Create an additional organization ("portal") for an existing user and make
   * them its OWNER. Unlike register(), this works for already-authenticated
   * users and does not require the app to be uninitialized.
   */
