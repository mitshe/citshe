...
export class UsersController {
  ...
  /**
   * Create an additional organization ("portal") for the current user.
   * The user becomes its OWNER. Returns the created organization.
   */
  @Post('organizations')
  @UseGuards(AuthGuard)
  @HttpCode(HttpStatus.CREATED)
  async createOrganization(
    ...
    const organization = await this.usersService.createOrganization(
      req.auth.userId,
      dto.name,
    );
    return { organization };
